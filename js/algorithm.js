class PeriodAlgo {
  constructor(helpers) {
    // Tip! This is some helping functions you can use in helpers.js if you need help!
  ...
  predictNextPeriodStartDate (data) {
    ...
    // Tip! Use the values in data.cycleLengths 

    
    // Step 2. Use the average cycle length to predict when the next cycle will start 
    // Tip! You might want to use data.currentCycleStart and the value you got from step 1
